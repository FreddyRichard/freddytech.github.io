<div class="container">
    ...
    <div class="">
        <div class="">
            <form action="<?= site_url('/actualizarAlumno') ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="password" name="password" placeholder="Se mantiene la contraseña">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="aula_id">
                        <?php foreach ($aulas as $aula) : ?>
                            ...
                            <?= ($aula['id'] == $alumno['aula_id']) ? 'selected' : '' ?>>
